/**
 * Verify Y3 Question Import
 * 
 * Quick verification script to check Y3 questions in database
 */
...
async function verifyImport() {
  console.log('\n🔍 Verifying Year 3 questions in database...\n')
  ...
  console.log(`✅ Total Year 3 questions: ${totalCount}`)
